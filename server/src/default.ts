    ...
    [
        ////////////////////////////////////////////////////// Type Type /////////////////////////////////////////////////////////
        {
            ...
            content: {
                ...
                content: [
                    ...
                    {type: TypePropType.bool, title: "Has sudo on", name:"hasSudoOn", description:"", default: false, template:false, variable:""} as IBoolTypeProp,
                    {type: TypePropType.bool, title: "Has contains", name:"hasContains", description:"", default: false, template:false, variable:""} as IBoolTypeProp,
                    {type: TypePropType.text, title: "Contains name", name:"contairsName", description:"", default: "Has", template:false, variable:""} as ITextTypeProp,
                    {type: TypePropType.typeContent, name:"content"} as ITypeContentTypeProp,  
                    {type: TypePropType.document, title: "Script", name:"script", description:"", lang: "Python", langName: "", template:false} as IDocumentTypeProp
                ]
            } as IType   
        },
        ...
        //////////////////////////////////////////////// Host Type //////////////////////////////////////////////////////////////
        {
            ...
            content: {
                ...
                nameVariable: "host",
                content: [
                    {type: TypePropType.password, title:"Password", name:"password", description: "The password the python client connects with"} as IPasswordTypeProp,
                    {type: TypePropType.bool, title: "Message on down", name:"messageOnDown",  description:"Should we generate messages when the server goes down", default: true, template: false, variable: ""} as IBoolTypeProp,
                ]
            } as IType   
        },
        ...
        //////////////////////////////////////////////// Root Type //////////////////////////////////////////////////////////////
        {
            ...
            content: {
                ...
                hasVariables: true,
                content: [
                    {type: TypePropType.document, title: "Preamble", name:"preamble", description:"", lang: "Python", langName: "", template:true, variable: "preamble"} as IDocumentTypeProp
                ]
            } as IType   
        },
        ...
        /////////////////////////////////////////////// User Type ////////////////////////////////////////////////////////////////
        {
            ...
            content: {
                ...
                nameVariable: "user",
                content: [
                    {type: TypePropType.text, title: "First Name", name:"firstName", description:"FirstName", default: "", template:false, variable:"firstName"} as ITextTypeProp,
                    {type: TypePropType.text, title: "Last Name", name:"lastName", description:"LastName", default: "", template:false, variable:"lastName"} as ITextTypeProp,
                    {type: TypePropType.text, title: "Email", name:"email", description:"Email", default: "", template:false, variable:"email"} as ITextTypeProp,
                    {type: TypePropType.text, title: "Shell", name:"shell", description:"Shell", default: "/bin/bash", template:true, variable:""} as ITextTypeProp,
                    {type: TypePropType.bool, title: "System", name:"system", description:"Should it be a system user", default: false, template: false, variable:""} as IBoolTypeProp,
                    {type: TypePropType.bool, title: "Sudo", name:"sudo", description:"Sudo", default: false, template:false, variable:""} as IBoolTypeProp,
                    {type: TypePropType.bool, title: "Admin", name:"admin", description:"Allow login into simpleadmin", default: false, template:false, variable:""} as IBoolTypeProp,
                    {type: TypePropType.password, title: "Password", name:"password", description:"The password to log in with"} as IPasswordTypeProp,                
