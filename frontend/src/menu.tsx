...
function MenuImpl(props:Props) {
    ...
    return (<Drawer open={true}>
        <List>
            <ListItem primaryText="Status" onClick={(e)=>props.setPage(e, {type:State.PAGE_TYPE.Dashbord})} href={page.link({type:State.PAGE_TYPE.Dashbord})}></ListItem>
            <Divider/>
